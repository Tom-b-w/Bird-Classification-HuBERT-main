...
def main():
    ...
    # 数据平衡处理
    df_train_balanced = balance_dataset(df_train, min_samples=200, max_samples=320)
    df_val_balanced = balance_dataset(df_val, min_samples=50, max_samples=80)
    ...
    with open('cnn_lstm_baseline_config.json', 'w', encoding='utf-8') as f:
    ...
    print("✓ 配置已保存到: cnn_lstm_baseline_config.json")
